...
async function runAllTests(server) {
  ...
  console.log('\n========== TEST RESULTS ==========');
  console.log('Solution 1 (entity_id in service_data):', success1 ? 'SUCCESS' : 'FAILED');
  console.log('Solution 2 (individual control):', success2 ? 'SUCCESS' : 'FAILED');
  console.log('Solution 3 (brightness instead of brightness_pct):', success3 ? 'SUCCESS' : 'FAILED');
  console.log('Solution 4 (target structure):', success4 ? 'SUCCESS' : 'FAILED');
